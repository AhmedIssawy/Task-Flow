...
const getStudentsPageOfUniversity = asyncHandler(async (req: Request, res: Response) => {
  const lang: Language = (req.cookies?.lang as Language) || "en";
...
const getAllStudentsOfUniversity = asyncHandler(async (req: Request, res: Response) => {
  const lang: Language = (req.cookies?.lang as Language) || "en";
  const { universityId } = req.params;
  const students = await Student.find({ universityId })
...
const getStudentsPage = asyncHandler(async (req: Request, res: Response) => {
  const lang: Language = (req.cookies?.lang as Language) || "en";
  const { page = 1, limit = 40 } = req.query;
...
const getStudentCourses = asyncHandler(async (req: Request, res: Response) => {
  const lang: Language = (req.cookies?.lang as Language) || "en";
  const { id } = req.params;
  const student = await Student.findById(id)
...
const getStudentCourseById = asyncHandler(async (req: Request, res: Response) => {
  const lang: Language = (req.cookies?.lang as Language) || "en";
