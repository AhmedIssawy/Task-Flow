...
export const validateCollegeCreation = (data) => {
  ...
  const allowedFields = [
    "name", "address", "phone", "email", "location", "description", "website", "establishedYear", "logo", "universityId"
  ];
...
export const validateCollegeUpdate = (data) => {
  ...
  const allowedFields = [
    "name", "address", "phone", "email", "location", "description", "website", "establishedYear", "logo", "universityId", "departments", "students"
  ];
  const filteredData = pickAllowedFields(data, allowedFields);
  return formatValidationResult(errors, filteredData);
};
